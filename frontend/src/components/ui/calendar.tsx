    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-8 select-none p-0 aria-disabled:opacity-50 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90",
        ...
        caption_label: cn(
          "select-none font-bold text-base",
          captionLayout === "label"
            ? ""
        ...
        weekday: cn(
          "text-muted-foreground w-[--cell-size] select-none text-sm font-semibold text-center",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "size-[--cell-size] rounded-lg text-sm font-normal",
        "hover:bg-white/10",
